"""
Django settings for projectoIndividual project.
...
ROOT_URLCONF = 'projectoIndividual.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.context.menu.menu_principal',
                'app.context.menu.menu_empleados'
            ],
        },
    },
]

WSGI_APPLICATION = 'projectoIndividual.wsgi.application'
